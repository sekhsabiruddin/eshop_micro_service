...
const fetchOrders = async () => {
  ...
  const res = await axios.get(`${base}/order/api/get-seller-orders`);
  console.log("fetching data from get-seller-orders", res);
...
const OrdersTable: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen p-8">
      ...
      {/* Breadcrumbs */}
      {/* Inline breadcrumbs */}
      <nav aria-label="breadcrumb" className="flex text-sm text-gray-400 mb-4">
